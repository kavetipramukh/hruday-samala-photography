  ...
  useGesture(
    {
      ...
      onDrag: ({ event, last, velocity: velArr = [0, 0], direction: dirArr = [0, 0], movement }) => {
        ...
        // Only prevent default for horizontal movements, allow vertical scrolling
        if (pointerTypeRef.current === 'touch' && Math.abs(dxTotal) > Math.abs(dyTotal)) {
        ...
        // Only apply horizontal rotation, ignore vertical
        const nextX = 0; // No vertical rotation
